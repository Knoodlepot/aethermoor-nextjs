...
### Added
- **Each subclass grants three signature abilities on selection**: Choosing your subclass at level 10 now grants three narrator-flavour abilities that shape how the world sees and responds to you. A Berserker gains Bloodlust, Iron Will, and The Last to Fall. A Paladin gains Holy Aura, Divine Mandate, and Blessed Blade. A Ranger gains Hunter's Patience, Wilderness Sight, and First Blood — and so on for all twelve subclasses. These abilities are permanent identity markers that the narrator weaves into every scene.
